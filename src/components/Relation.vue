<template>
    <tr>
        ...
        <td>
            <span v-if="relation.type == 'belongsToMany'" @click="setPivot" class="btn btn-default">
                {{ plus(relation.pivot) }}
            </span>
        </td>
        <td>
            <span v-if="hasForeignKey" @click="setForeignKey" class="btn btn-default">
                {{ plus(relation.foreignKey) }}
            </span>
        </td>
        <td>
